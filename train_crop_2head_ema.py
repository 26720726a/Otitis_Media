...
# [모델 파일 고정]
# ==========================================================
MODEL_FILE = "model_convNeXt-Tiny_crop_2head_ema.py"
...
def train():
    ...
    print(f"옵션: CLAHE={USE_CLAHE}, 2.5D={USE_25D}, FocalLoss={USE_FOCAL_LOSS}, "
          f"NUM_FOLDS={NUM_FOLDS}, NUM_TASKS={NUM_TASKS}(crop, 2-head shared-otitis)")
...
def train_fullfit(fullfit_epochs):
    ...
    print(f"옵션: CLAHE={USE_CLAHE}, 2.5D={USE_25D}, FocalLoss={USE_FOCAL_LOSS}, "
          f"drop_last=True, NUM_TASKS={NUM_TASKS}(crop, 2-head shared-otitis)")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="TBCT Crop 2-head shared-otitis 학습 스크립트 + EMA (model_convNeXt-Tiny_crop_2head_ema.py 전용)",
        usage="python3 train_crop_2head_ema.py [--fullfit] [--fullfit-epochs N] [--dump-crops]",
    )
