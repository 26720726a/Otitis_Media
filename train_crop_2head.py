...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="TBCT Crop 2-head shared-otitis 학습 스크립트 (model_convNeXt-Tiny_crop_2head.py 전용)",
        usage="python3 train_crop_2head.py [--fullfit] [--fullfit-epochs N] [--dump-crops]",
    )
