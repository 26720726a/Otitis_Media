...
# 전체 데이터를 학습한다.
#
# ★ 2-head 공유 otitis 실험 전용 격리 파일
#   train_crop_2head.py / inference_crop_2head.py 전용으로 사용.
#   체크포인트: best_model_convNeXt-Tiny_crop_2head_fold{k}.pth
#   stats:      preproc_model_convNeXt-Tiny_crop_2head_stats.json
# ==========================================================
NUM_TASKS  = 2
...
class MyModel(nn.Module):
    """
    2-Head ConvNeXt-Tiny (crop 입력 전용) — 2-head 공유 otitis 실험용
