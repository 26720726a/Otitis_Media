...
# [모델 파일 고정]
# ==========================================================
MODEL_FILE = "model_convNeXt-Tiny_crop_3head.py"
...
# ==========================================================
def dump_crops(data_root, train_csv, n_patients=4, out_dir="./crop_3head_debug"):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="TBCT Crop 3-head without-flip 학습 스크립트 (model_convNeXt-Tiny_crop_3head.py 전용)",
        usage="python3 train_crop_3head.py [--fullfit] [--fullfit-epochs N] [--dump-crops]",
    )
    ...
    parser.add_argument("--dump-crops", action="store_true",
                        help="crop 디버그 이미지를 ./crop_3head_debug/에 저장 후 종료 (학습 안 함)")
